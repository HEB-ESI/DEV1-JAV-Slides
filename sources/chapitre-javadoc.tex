...
\begin{frame}[fragile]{Javadoc}
	\sigle{\bf javadoc}
	\begin{itemize}
		\item Commentaire \sigle{javadoc} identifié par  {\small \java{/** ... */}}
\begin{Java}
/**
    Calcule et retourne le maximum de 2 nombres.
*/
\end{Java}
		\item La documentation est produite au format \sigle{HTML}
...
\begin{frame}[fragile]{Production de la documentation}
	...
	\begin{itemize}
		\item \code{javadoc Temps.java}
		\item \code{javadoc *.java}
		\item \code{javadoc -d doc *.java}
		\item \code{javadoc -charset utf-8 *.java}
