...
\imgfullh{../img/The_choice_by_vallo29.jpg}{}{http://vallo29.deviantart.com/art/The-choice-150871274}
...
\begin{Java}
  switch(produit) {
    case "Coca" : 
    case "Sprite" : 
    case "Fanta" :  prixDistributeur=60; break;
    case "IceTea" : prixDistributeur=70; break;
    case "Aquarius" : 
    case "Nalu" :   prixDistributeur=80; break;
    default :       prixDistributeur=0 break;
  }
\end{Java}
\begin{itemize}
