...
\begin{frame}{Allocation mémoire}
	Pour un type \emph{référence} (ex: String, tableau)
	\begin{itemize}
...
\note{
	...
	\begin{itemize}
		...
		\item Composé de \textit{lettres}, de \textit{chiffres}, dollar et souligné
...
\note{
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Eviter dollar et souligné
...
\begin{frame}[fragile]{Constante}
	...
	\begin{itemize}
		...
		\item Utiliser un souligné  pour séparer les mots
	\end{itemize} 
	\bigskip
	\emph{Exemples}
	\begin{Java}
