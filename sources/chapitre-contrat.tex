...
\emph{Quoique}
\begin{itemize}
	\item les slides sur \href{https://github.com/HEB-ESI/DEV1-LGJ-Slides}{github};
...
\begin{frame}{Évaluation}
	Évaluation de l'unité d'enseigement, une cote pour toutes les activités d'apprentissage:
	\bigskip
	\par\centering{\color{darkgray}\large\bf ALG - LGJ - LAJ}
\end{frame}
